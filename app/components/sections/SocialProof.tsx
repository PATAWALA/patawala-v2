...
interface ProjectType {
  ...
  description: string;
  cta: string;
  // 'message' a été supprimé car inutilisé
}
...
const SocialProof = memo(function SocialProof() {
  ...
  // Types de projets - sans la propriété 'message'
  ...
  return (
    ...
    >
      {/* FOND AMÉLIORÉ - densité et animations */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0B1120] via-[#0A0F1C] to-[#1a1f35]">
        {/* Lignes subtiles - opacité augmentée à 0.08 */}
        <div
