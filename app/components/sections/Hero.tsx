    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 relative z-10 py-6 sm:py-8 md:py-10 lg:py-12 pt-16 sm:pt-15 md:pt-24 lg:pt-28">
          ...
          {/* Contenu principal - FLEX avec layout amélioré */}
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 sm:gap-10 md:gap-12 lg:gap-8 xl:gap-16 max-w-6xl mx-auto">
            ...
            {/* Photo de profil - AGRANDIE COMME DANS ABOUT */}
            <div className="flex-1 flex justify-center relative order-1 lg:order-2 w-full mb-4 sm:mb-6 lg:mb-0">
              
              {/* Conteneur avec dimensions AGRANDIES comme dans About */}
              <div className="relative w-full max-w-[240px] xs:max-w-[280px] sm:max-w-[320px] md:max-w-[380px] lg:max-w-[420px] xl:max-w-[480px]">
                ...
                {/* Badge en haut à droite - REPOSITIONNÉ pour plus d'espace */}
                <div 
                  className="absolute top-0 right-0 z-30"
                  style={{ transform: 'translate(10%, -10%)' }}
                >
                  <div className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-1.5 sm:px-2 md:px-3 lg:px-4 py-1 sm:py-1.5 rounded-full shadow-lg flex items-center gap-1 sm:gap-1.5 border border-[#1F2937]">
                    <Globe size={8} className="xs:w-2 xs:h-2 sm:w-3 sm:h-3 md:w-4 md:h-4" aria-hidden="true" />
                    <Smartphone size={8} className="xs:w-2 xs:h-2 sm:w-3 sm:h-3 md:w-4 md:h-4" aria-hidden="true" />
                    <span className="text-[8px] xs:text-[8px] sm:text-[10px] md:text-xs lg:text-sm font-semibold whitespace-nowrap">Multi-support</span>
                  </div>
                </div>

                {/* Badge en bas à gauche - REPOSITIONNÉ pour plus d'espace */}
                <div 
                  className="absolute bottom-0 left-0 z-30"
                  style={{ transform: 'translate(-10%, 10%)' }}
                >
                  <div className="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-1.5 sm:px-2 md:px-3 lg:px-4 py-1 sm:py-1.5 rounded-full shadow-lg flex items-center gap-1 sm:gap-1.5 border border-[#1F2937]">
                    <div className="w-1.5 h-1.5 xs:w-2 xs:h-2 sm:w-2.5 sm:h-2.5 bg-white rounded-full" />
                    <span className="text-[8px] xs:text-[8px] sm:text-[10px] md:text-xs lg:text-sm font-semibold whitespace-nowrap">Disponible</span>
                  </div>
                </div>
                ...
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl border-3 sm:border-4 border-[#1F2937] bg-[#141B2B]">
                  <div className="aspect-square relative">
                    <Image
                      ...
                      sizes="(max-width: 480px) 240px, (max-width: 640px) 280px, (max-width: 768px) 320px, (max-width: 1024px) 380px, 420px"
                      priority
                      quality={85}
                      placeholder="blur"
          ...
          {/* Micro-CTA */}
          <div className="flex justify-center mt-8 sm:mt-10 md:mt-12 lg:mt-14 xl:mt-16 px-2 sm:px-3 lg:px-0">
