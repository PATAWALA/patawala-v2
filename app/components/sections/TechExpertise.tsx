  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#0B1120] via-[#0A0F1C] to-[#1a1f35]">
        {/* Lignes subtiles - une seule couche pour réduire le rendu */}
        <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8 max-w-7xl mx-auto mb-16 md:mb-20 auto-rows-fr">
          {Array.isArray(techStack) && techStack.map((tech, index) => {
            ...
            return (
              <div
                key={tech.name}
                className="group bg-[#141B2B] rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 border border-[#1F2937] shadow-lg hover:shadow-xl hover:border-blue-500/30 transition-all duration-300 relative flex flex-col will-change-transform"
              >
                <div className="relative z-10 flex-1 flex flex-col">
                  ...
                  {/* Points d'expertise - OPTIMISÉS */}
                  <div className="space-y-1.5 sm:space-y-2 mb-4 sm:mb-5 flex-1">
                    {tech.expertise.slice(0, 3).map((item: string) => ( // Limiter à 3 points max pour la perf
                  ...
                  <div className="mt-4 pt-4 border-t border-[#1F2937]">
                    ...
                    <div className="w-full h-1.5 bg-gray-700 rounded-full mt-2 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: isExpert ? '90%' : isAdvanced ? '80%' : '70%'
                        }}
                      />
                    </div>
                  </div>
