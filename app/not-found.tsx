...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1C] relative overflow-hidden flex items-center justify-center p-4 pt-24">
      ...
      {/* Éléments décoratifs animés - adaptés au thème sombre */}
      <motion.div
        animate={{
          x: mousePosition.x,
          y: mousePosition.y,
      ...
      <div className="relative z-10 max-w-3xl w-full">
        ...
        <div className="relative mb-8 flex justify-center">
          <motion.div
            ...
            className="relative"
          >
            {/* Chiffres 404 avec effet de profondeur */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/">
              <motion.div
                ...
                className="flex items-center gap-3 p-4 bg-blue-500/10 rounded-xl hover:bg-blue-500/20 transition-colors cursor-pointer group border border-blue-500/20"
              >
            ...
            <Link href="/#contact">
              <motion.div
                whileHover={{ scale: 1.02, x: 4 }}
                className="flex items-center gap-3 p-4 bg-blue-500/10 rounded-xl hover:bg-blue-500/20 transition-colors cursor-pointer group sm:col-span-2 border border-blue-500/20"
              >
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        {/* Effet de particules - adapté au thème sombre */}
