    ...
    <>
      ...
      <main className="min-h-screen pt-20 sm:pt-24 pb-16 sm:pb-20 bg-[#0A0F1C] relative overflow-hidden font-sans">
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 relative z-10">
          ...
          {/* Formulaire Brevo - VERSION RÉDUITE */}
                      ...
                      <div style={{ padding: '4px 0' }}>
                        <div className="sib-form-block" style={{ fontSize: '14px', textAlign: 'center', fontFamily: 'Helvetica, sans-serif', color: '#9CA3AF', backgroundColor: 'transparent', marginBottom: '8px' }}>
                          <div className="sib-text-form-block">
                            <p>Une analyse chaque semaine sur le dev, l'IA et l'entrepreneuriat</p>
                          </div>
                        </div>
                      </div>
                      <div style={{ padding: '4px 0' }}>
                        <div className="sib-input sib-form-block">
                          <div className="form__entry entry_block">
                            <div className="form__label-row">
                              <label className="entry__label" style={{ fontWeight: '600', textAlign: 'left', fontSize: '14px', fontFamily: 'Helvetica, sans-serif', color: '#FFFFFF', display: 'block', marginBottom: '6px' }} htmlFor="EMAIL">Email</label>
